				...
				<div class="col-sm-9">
					...
					<form role="form" method="POST" action="/comment">
						...
						<div class="input-group">
								...
								<input class="form-control" placeholder="Message" value="{{$sanpham->id}}" name="idd" type="text" autofocus>
							</div>
							<div class="input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control" placeholder="Email" name="image" type="file">
							</div>
						</div>

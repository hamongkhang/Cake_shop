				...
				<div class="item-slick2 p-l-15 p-r-15">
					...
					<div class="block2">
						...
						<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
							...
							<a href="{{route('addcart2',$new->id)}}" class="block2-btn-addwishlist hov-pointer trans-0-4">
								<button>
				...
				<div class="item-slick2 p-l-15 p-r-15">
					...
					<div class="block2">
						<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
							...
							<div class="block2-overlay trans-0-4">
							<a href="{{route('addcart2',$sale->id)}}" class="block2-btn-addwishlist hov-pointer trans-0-4">
								<button>
								<i class="icon-wishlist icon_heart_alt" aria-hidden="true"></i>
									<i class="icon-wishlist icon_heart dis-none" aria-hidden="true"></i>
									</button>
				...
				<div class="item-slick2 p-l-15 p-r-15">
					...
					<div class="block2">
						...
						<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
							...
							<div class="block2-overlay trans-0-4">
							<a href="{{route('addcart2',$hot->id)}}" class="block2-btn-addwishlist hov-pointer trans-0-4">
								<button>
								<i class="icon-wishlist icon_heart_alt" aria-hidden="true"></i>
									<i class="icon-wishlist icon_heart dis-none" aria-hidden="true"></i>
									</button>

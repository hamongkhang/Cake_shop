				...
				<div class="topbar-child2">
					<div class="topbar-language rs1-select2">
						<select class="selection-1" name="time" onchange="location = this.value;">
							...
							<option value="locale/vi">Vietnamese</option>
				...
				<div class="header-icons">
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-total">
								{{Cart::instance('shopping')->subtotal()}} VNĐ
							</div>
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-total">
								{{Cart::instance('wishlist')->subtotal()}} VNĐ
							</div>

							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a style="text-decoration: none" href="{{route('wishlist')}}" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										Xem Wishlist
									</a>
								</div>
							</div>
